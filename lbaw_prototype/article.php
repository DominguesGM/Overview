        ...
        <div>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <h4> <img src="http://packetcode.com/apps/wall-design/image.jpg" class="img-circle" width="5%"/>
                <a href="#">John Doe</a></h4> <!--If author, show edit options instead-->
              </div>
            </div>
        ...
        <div class="comments-list">
          <div class="media comment">
            ...
            <a class="media-left" href="#">
              <img class="img-circle" src="http://lorempixel.com/40/40/people/1/">
            </a>
            <div class="media-body">
          ...
          <div class="media comment">
            ...
            <div class="comment-vote"><a href="#"><i class="fa fa-arrow-up"></i></a><br><a href="#"><i class="fa fa-arrow-down"></i></a></div>
            <a class="media-left" href="#">
              <img class="img-circle" src="http://lorempixel.com/40/40/people/2/">
            </a>
            <div class="media-body">
          ...
          <div class="media comment">
            ...
            <div class="comment-vote"><a href="#"><i class="fa fa-arrow-up"></i></a><br><a href="#"><i class="fa fa-arrow-down"></i></a></div>
            <a class="media-left" href="#">
              <img class="img-circle" src="http://lorempixel.com/40/40/people/3/">
            </a>
            <div class="media-body">
          ...
          <div class="media comment">
            ...
            <div class="comment-vote"><a href="#"><i class="fa fa-arrow-up"></i></a><br><a href="#"><i class="fa fa-arrow-down"></i></a></div>
            <a class="media-left" href="#">
              <img class="img-circle" src="http://lorempixel.com/40/40/people/4/">
            </a>
            <div class="media-body">
