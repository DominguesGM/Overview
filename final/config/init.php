<?php
  session_set_cookie_params(3600, "/~lbaw1566/");
  session_start();

  error_reporting(E_ERROR | E_WARNING); // E_NOTICE by default

  $BASE_DIR = '/opt/lbaw/lbaw1566/public_html/final/';
  $BASE_URL = '/~lbaw1566/final/';

  $conn = new PDO('pgsql:host=dbm.fe.up.pt;port=5432;dbname=lbaw1566', 'lbaw1566', 'GH43P4H8');
  $conn->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_ASSOC);
  $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

  $conn->exec('SET SCHEMA \'lbaw\'');
